...
function calculate() {
    ...
    let stringCompare = displayUpper.value.split('');
    // 0a Find if array includes any of '/+*+' and if not return the starting input
    displayUpper.value.match(/[/*+-]/g) ? console.log("yes") : console.log("no")
